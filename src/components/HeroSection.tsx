...
const HeroSection = () => {
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-gentle">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-center mb-6">
            <div className="flex items-center space-x-2 bg-primary/10 px-4 py-2 rounded-full border border-primary/20">
              ...
              <span className="text-primary font-medium">Authentic Community in Gothenburg</span>
            </div>
          </div>
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 leading-relaxed max-w-3xl mx-auto">
            A welcoming space for authentic relating, circling practices, and deep interpersonal connection in Gothenburg. 
            Join facilitators and practitioners creating meaningful community together.
          </p>
