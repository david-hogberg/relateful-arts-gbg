      ...
      <section className="py-20 bg-gradient-warm">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">Discover the many ways our community supports interpersonal practice</p>
          </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">We believe in creating spaces where people can show up authentically, practice vulnerable communication, and build meaningful connections. Our community is built on principles of curiosity, conscious boundaries and compassionate presence.</p>
